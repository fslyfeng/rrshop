...
class Perm_EweiShopV2ComModel extends ComModel
{
	...
	protected function perm_app()
	{
		return $this->isopen('app') && $this->is_perm_plugin('app') ? array(
			...
			'page'       => array(
				...
				'add'  => '添加-log',
				'edit' => '编辑-log',
				'xxx'  => array('delete' => 'edit', 'status' => 'edit', 'setdefault' => 'edit')
			),
	...
	protected function perm_store()
	{
		$perm = array(
			...
			'verifygoods'     => array('text' => '记次时商品核销管理', 'edit' => '修改-log', 'view' => '查看', 'deletelog' => '删除核销记录'),
	...
	protected function perm_invitation()
	{
		return $this->isopen('invitation') && $this->is_perm_plugin('invitation') ? array(
			...
			'invitation' => array('text' => '邀请卡管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'log' => '扫描记录-log', 'deleted' => '删除-log')
		) : array();
	}
	...
	public function perm_membercard()
	{
		return $this->isopen('membercard') && $this->is_perm_plugin('membercard') ? array(
			...
			'cardmanage' => array('text' => '会员卡管理', 'main' => '会员卡列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log', 'status' => '启用/停发-log'),
			'getrecord'  => array('text' => '领取记录', 'main' => '查看'),
			'delrecord'  => array('text' => '删除记录', 'main' => '查看', 'view' => '已领取记录')
		) : array();
	}
