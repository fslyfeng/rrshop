...
class Perm_EweiShopV2ComModel extends ComModel
{
	...
	public function allPerms()
	{
		if (empty(self::$allPerms)) {
			$perms = array('shop' => $this->perm_shop(), 'goods' => $this->perm_goods(), 'member' => $this->perm_member(), 'order' => $this->perm_order(), 'store' => $this->perm_store(), 'finance' => $this->perm_finance(), 'statistics' => $this->perm_statistics(), 'sysset' => $this->perm_sysset(), 'sale' => $this->perm_sale(), 'bargain' => $this->perm_bargain(), 'exchange' => $this->perm_exchange(), 'commission' => $this->perm_commission(), 'diyform' => $this->perm_diyform(), 'poster' => $this->perm_poster(), 'postera' => $this->perm_postera(), 'taobao' => $this->perm_taobao(), 'article' => $this->perm_article(), 'creditshop' => $this->perm_creditshop(), 'exhelper' => $this->perm_exhelper(), 'diypage' => $this->perm_diypage(), 'groups' => $this->perm_groups(), 'perm' => $this->perm_perm(), 'globonus' => $this->perm_globonus(), 'merch' => $this->perm_merch(), 'mr' => $this->perm_mr(), 'qa' => $this->perm_qa(), 'abonus' => $this->perm_abonus(), 'pstore' => $this->perm_pstore(), 'sign' => $this->perm_sign(), 'wangdian' => $this->perm_wangdian(), 'quick' => $this->perm_quick(), 'author' => $this->perm_author(), 'sns' => $this->perm_sns(), 'backone' => $this->perm_backone(), 'task' => $this->perm_task(), 'cashier' => $this->perm_cashier(), 'seckill' => $this->perm_seckill(), 'lottery' => $this->perm_lottery(), 'threen' => $this->perm_threen(), 'messages' => $this->perm_messages(), 'app' => $this->perm_app(), 'polyapi' => $this->perm_polyapi(), 'mmanage' => $this->perm_mmanage(), 'newstore' => $this->perm_newstore(), 'live' => $this->perm_live(), 'invitation' => $this->perm_invitation(), 'offic' => $this->perm_offic(), 'cycelbuy' => $this->perm_cycelbuy(), 'dividend' => $this->perm_dividend(), 'membercard' => $this->perm_membercard(), 'friendcoupon' => $this->perm_friendcoupon(), 'messikefu' => $this->perm_openmessikefu(), 'goodscircle' => $this->perm_goodscircle(), 'pc' => $this->perm_pc());
			self::$allPerms = $perms;
		}
	...
	protected function perm_app()
	{
		return $this->isopen('app') && $this->is_perm_plugin('app') ? array(
			...
			'page'       => array(
				...
				'add'  => '添加-log',
				'edit' => '编辑-log',
				'xxx'  => array('delete' => 'edit', 'status' => 'edit', 'setdefault' => 'edit', 'cancel_default' => 'edit')
			),
			'goods'      => array('text' => '商品二维码', 'main' => '查看'),
			'setting'    => array('text' => '基本设置', 'main' => '查看', 'edit' => '基本设置-log', 'pay' => '支付设置-log'),
			'tabbar'     => array(
				'text' => '底部导航',
				'main' => '保存-log',
				'xxx'  => array('submit' => 'main')
			),
			'newrelease' => array(
				'text' => '新版发布',
				'main' => '提交-log',
				'xxx'  => array('audit' => 'main')
			),
			'release'    => array(
				'text' => '旧版发布',
				'main' => '提交-log',
	...
	protected function perm_polyapi()
	{
		return $this->isopen('polyapi') && $this->is_perm_plugin('polyapi') ? array(
			...
			'set'  => array('text' => '基本设置', 'edit' => '修改-log')
		) : array();
	}
	...
	protected function perm_store()
	{
		$perm = array(
			...
			'delete'          => '删除-log',
			'set'             => '关键词设置-log',
			'goods'           => array('text' => '门店商品管理', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
			'goodsgroup'      => array('text' => '门店商品组管理', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'view' => '查看', 'delete' => '删除-log'),
			'storegroup'      => array('text' => '门店分组管理', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'view' => '查看', 'delete' => '删除-log'),
			'saler'           => array('text' => '店员管理', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '修改-log', 'view' => '查看', 'delete' => '删除-log'),
			'verifygoods'     => array('text' => '记次时商品核销管理', 'edit' => '修改-log', 'detail' => '修改详情', 'view' => '查看', 'deletelog' => '删除核销记录'),
			'verifyorder.log' => array('text' => '核销订单记录', 'export' => '导出-log', 'view' => '查看'),
			'verify.log'      => array('text' => '记次时商品统计', 'main' => '查看列表')
		);
	...
	protected function perm_newstore()
	{
		return $this->isopen('newstore') && $this->is_perm_plugin('newstore') ? array(
			...
			'temp'   => array('text' => '模板管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log', 'delete1' => '彻底删除-log'),
			'ngoods' => array('text' => '预约商品管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'deleted' => '删除-log'),
			'norder' => array('text' => '预约订单', 'main' => '查看列表', 'view' => '查看内容'),
			'set'    => array('text' => '基础设置', 'edit' => '编辑-log')
		) : array();
	}

	protected function perm_invitation()
	{
		return $this->isopen('invitation') && $this->is_perm_plugin('invitation') ? array('text' => m('plugin')->getName('invitation'), 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'log' => '扫描记录-log', 'delete' => '删除-log') : array();
	}
	...
	protected function perm_offic()
	{
		return $this->isopen('offic') && $this->is_perm_plugin('offic') ? array(
			...
			'system'  => array('text' => '系统文案管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'log' => '扫描记录-log', 'deleted' => '删除-log'),
			'agent'   => array('text' => '用户文案管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'log' => '扫描记录-log', 'deleted' => '删除-log'),
			'adv'     => array(
				'text'   => '幻灯片',
				'main'   => '查看列表',
				'view'   => '查看内容',
			...
			'cover'   => array('text' => '入口设置', 'edit' => '编辑-log'),
			'setting' => array('text' => '基础设置', 'edit' => '编辑-log')
		) : array();
	}
	...
	protected function perm_live()
	{
		return $this->isopen('live') && $this->is_perm_plugin('live') ? array(
			...
			'room'     => array('text' => '直播间管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'console' => '控制台-log', 'deleted' => '删除-log'),
			'category' => array('text' => '分类管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
			'banner'   => array('text' => '幻灯片管理', 'main' => '查看列表', 'view' => '查看内容', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
			'cover'    => array('text' => '入口设置', 'edit' => '编辑-log'),
			'set'      => array('text' => '基础设置', 'edit' => '编辑-log')
		) : array();
	}
	...
	protected function perm_exchange()
	{
		return $this->isopen('exchange') && $this->is_perm_plugin('exchange') ? array(
			...
			'goods'     => array('text' => '商品兑换', 'edit' => '添加/编辑兑换', 'creat' => '生成兑换券', 'status' => '修改状态', 'destroy' => '删除兑换码', 'delete' => '删除兑换任务'),
			'balance'   => array('text' => '余额兑换', 'edit' => '添加/编辑兑换', 'creat' => '生成兑换券', 'status' => '修改状态', 'destroy' => '删除兑换码', 'delete' => '删除兑换任务'),
			'redpacket' => array('text' => '红包兑换', 'edit' => '添加/编辑兑换', 'creat' => '生成兑换券', 'status' => '修改状态', 'destroy' => '删除兑换码', 'delete' => '删除兑换任务'),
			'score'     => array('text' => '积分兑换', 'edit' => '添加/编辑兑换', 'creat' => '生成兑换券', 'status' => '修改状态', 'destroy' => '删除兑换码', 'delete' => '删除兑换任务'),
			'coupon'    => array('text' => '优惠券兑换', 'edit' => '添加/编辑兑换', 'creat' => '生成兑换券', 'status' => '修改状态', 'destroy' => '删除兑换码', 'delete' => '删除兑换任务'),
			'group'     => array('text' => '组合兑换', 'edit' => '添加/编辑兑换', 'creat' => '生成兑换券', 'status' => '修改状态', 'destroy' => '删除兑换码', 'delete' => '删除兑换任务'),
			'record'    => array('text' => '兑换订单', 'main' => '全部订单', 'daifahuo' => '待发货', 'daishouhuo' => '待收货', 'daifukuan' => '待收货', 'yiguanbi' => '待收货', 'yiwancheng' => '已完成'),
			'setting'   => array('text' => '文件管理', 'download' => '文件管理', 'other' => '其他设置'),
			'history'   => array('text' => '兑换记录', 'history' => '兑换记录')
		) : array();
	}
	...
	protected function perm_order()
	{
		return array(
			...
			'op'        => array(
				...
				'refund'        => array('text' => '维权', 'main' => '维权信息-log', 'submit' => '提交维权申请-log'),
	...
	protected function perm_sysset()
	{
		return array(
			...
			'payment'  => array('text' => '支付管理', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
			...
			'printer'  => array('text' => '小票打印机', 'main' => '模板库', 'printer_list' => '打印机管理', 'printer_add' => '打印机添加-log', 'printer_edit' => '打印机编辑-log', 'printer_delete' => '打印机删除-log', 'add' => '打印模板添加-log', 'edit' => '打印模板编辑-log', 'delete' => '打印模板删除-log', 'set' => '打印设置-log'),
			'cover'    => array(
	...
	protected function perm_commission()
	{
		return $this->isopen('commission') && $this->is_perm_plugin('commission') ? array(
			...
			'statistics' => array(
				'order' => array('text' => '分销订单', 'main' => '查看列表'),
				'agent' => array('text' => '分销商统计', 'main' => '查看列表', 'edit' => '修改-log', 'delete' => '删除-log'),
				'user'  => array('text' => '分销关系', 'main' => '查看列表', 'edit' => '修改-log', 'delete' => '删除-log')
			),
	...
	protected function perm_groups()
	{
		return $this->isopen('groups') && $this->is_perm_plugin('groups') ? array(
			...
			'exhelper'  => array('text' => '快递打印', 'view' => '查看', 'edit' => '编辑-log'),
			'batchsend' => array('text' => '批量发货', 'view' => '查看', 'edit' => '编辑-log')
		) : array();
	}
	...
	protected function perm_creditshop()
	{
		return $this->isopen('creditshop') && $this->is_perm_plugin('creditshop') ? array(
			...
			'goods'    => array(
				...
				'edit'   => '修改-log',
				'delete' => '删除-log',
				'xxx'    => array('property' => 'edit', 'query' => 'edit', 'querygoods' => 'edit', 'status' => 'edit', 'recycle' => 'edit', 'deleted' => 'delete')
			),
			'category' => array(
				'text'   => '分类',
				'main'   => '查看列表',
				...
				'edit'   => '修改-log',
				'delete' => '删除-log',
				'xxx'    => array('enabled' => 'edit', 'query' => 'edit', 'displayorder' => 'edit')
			),
			'adv'      => array(
				'text'   => '幻灯片',
				'main'   => '查看列表',
			...
			'log'      => array('text' => '订单/记录', 'exchange' => '兑换记录', 'draw' => '抽奖记录', 'order' => '待发货', 'convey' => '待收货', 'finish' => '已完成', 'verifying' => '待核销', 'verifyover' => '已核销', 'verify' => '全部核销', 'detail' => '详情', 'doexchange' => '确认兑换-log', 'goodsfinish' => '确认收货-log', 'export' => '导出明细-log'),
	...
	protected function perm_mmanage()
	{
		return $this->isopen('mmanage') && $this->is_perm_plugin('mmanage') ? array(
			...
			'setting' => array('text' => '基本设置', 'main' => '查看', 'save' => '保存-log')
		) : array();
	}
	...
	protected function perm_exhelper()
	{
		return $this->isopen('exhelper') && $this->is_perm_plugin('exhelper') ? array(
			...
			'esheetprint' => array(
				'single' => array('text' => '单个打印', 'express' => '打印电子面单-log', 'dosend' => '一键发货-log'),
				'batch'  => array('text' => '批量打印', 'express' => '打印电子面单-log', 'dosend' => '一键发货-log')
			),
			'temp'        => array(
				'express' => array(
					'text'   => '快递单模板管理',
	...
	protected function perm_hotelreservation()
	{
		return $this->isopen('hotelreservation') && $this->is_perm_plugin('hotelreservation') ? array(
			...
			'goods'     => array('text' => '民宿商品管理', 'view' => '查看', 'add' => '添加-log', 'edit' => '编辑-log'),
			'adv'       => array(
				'text'   => '幻灯片管理',
				'main'   => '查看列表',
				'view'   => '查看',
	...
	protected function perm_task()
	{
		...
		if ($isnew && p('task')->isnew()) {
			return array(
				...
				'edit'     => '编辑-log',
				'delete'   => '删除-log',
				'record'   => array('text' => '任务记录', 'main' => '查看'),
				'reward'   => array('text' => '奖励记录', 'main' => '查看'),
				'notice'   => array('text' => '消息通知', 'main' => '编辑'),
				'setting'  => array('text' => '系统设置', 'edit' => '编辑')
			);
		}
		...
		return array(
			...
			'clear'            => '清除缓存-log',
			'xxx'              => array('setdefault' => 'edit'),
			'extension.single' => array('text' => '单次任务', 'main' => '查看'),
			'extension.repeat' => array('text' => '周期任务', 'main' => '查看'),
			'log'              => array('text' => '关注记录', 'main' => '查看'),
			'adv'              => array(
				'text'   => '幻灯片',
				'main'   => '查看列表',
	...
	protected function perm_cycelbuy()
	{
		return $this->isopen('cycelbuy') && $this->is_perm_plugin('cycelbuy') ? array(
			...
			'goods'   => array('text' => '商品管理', 'main' => '浏览列表', 'detail' => '查看详情', 'add' => '添加', 'edit' => '修改', 'delete' => '删除', 'delete1' => '彻底删除'),
			'order'   => array('text' => '订单管理', 'status_1' => '浏览关闭订单', 'status0' => '浏览待付款订单', 'status1' => '浏览已付款订单', 'status2' => '浏览已发货订单', 'status3' => '浏览完成的订单', 'status4' => '维权申请', 'status5' => '维权完成'),
			'op'      => array(
				'text'          => '操作',
				'delete'        => '订单删除-log',
				'pay'           => '确认付款-log',
			...
			'refund'  => array('text' => '地址修改审核', 'main' => '浏览申请', 'detail' => '浏览详情', 'disagree' => '审批操作', 'save' => '添加修改'),
			'comment' => array('text' => '评价管理', 'main' => '浏览评价', 'edit' => '修改虚拟评价', 'add' => '添加虚拟评价', 'post' => '修改评价', 'virtual' => '虚拟评价操作'),
			'notice'  => array('text' => '通知设置', 'main' => '查看', 'edit' => '修改-log'),
			'set'     => array('text' => '基本设置', 'main' => '查看', 'edit' => '修改-log')
		) : array();
	}
	...
	public function perm_dividend()
	{
		return $this->isopen('dividend') && $this->is_perm_plugin('dividend') ? array(
			...
			'agent'      => array(
				...
				'user'   => '查看团员',
				'export' => '导出-log',
				'xxx'    => array('check' => 'edit')
			),
			'statistics' => array(
				'order' => array('text' => '分红订单', 'main' => '查看列表')
			),
			'apply'      => array('text' => '分红审核', 'view1' => '待审核浏览', 'view2' => '待打款浏览', 'view3' => '已打款浏览', 'view_1' => '无效分红浏览', 'detail' => '详细分红', 'check' => '审核-log', 'pay' => '打款-log', 'cancel' => '重新审核-log', 'refuse' => '驳回申请-log', 'export' => '导出-log'),
			'notice'     => array('text' => '通知设置', 'main' => '查看', 'edit' => '修改-log'),
			'cover'      => array('text' => '入口设置', 'main' => '查看', 'edit' => '修改-log'),
			'set'        => array('text' => '基本设置', 'main' => '查看', 'edit' => '修改-log')
		) : array();
	...
	public function perm_membercard()
	{
		return $this->isopen('membercard') && $this->is_perm_plugin('membercard') ? array(
			...
			'cardmanage' => array('text' => '会员卡管理', 'main' => '会员卡列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
			'getrecord'  => array('text' => '领取记录', 'main' => '查看')
		) : array();
	}
	...
	public function perm_friendcoupon()
	{
		return $this->isopen('friendcoupon') && $this->is_perm_plugin('friendcoupon') ? array(
			...
			'activity_list' => array('text' => '活动设置', 'main' => '查看列表', 'add' => '添加-log', 'edit' => '编辑-log', 'delete' => '删除-log', 'copy' => '复制-log', 'stop' => '停止-log'),
			'statistics'    => array('text' => '数据统计', 'main' => '查看列表')
		) : array();
	}
	...
	public function perm_goodscircle()
	{
		return $this->isopen('goodscircle') && $this->is_perm_plugin('goodscircle') ? array(
			...
			'set'  => array('text' => '基本设置', 'main' => '修改-log')
		) : array();
	}
	...
	public function perm_pc()
	{
		return $this->isopen('pc') && $this->is_perm_plugin('pc') ? array(
			...
			'goods'       => array('text' => '商品组管理', 'main' => '商品组列表', 'add' => '添加-log', 'edit' => '修改-log', 'delete' => '删除-log'),
			'menu'        => array(
				'text'   => '菜单管理',
				'top'    => '顶部导航',
				'bottom' => '底部导航',
				'add'    => '添加-log',
				'edit'   => '修改-log',
				'xxx'    => array('switchChange' => 'edit')
			),
			'adv'         => array('text' => '广告管理', 'banner' => '首页轮播', 'recommend' => '推荐广告'),
			'typesetting' => array('text' => '排版设置', 'main' => '查看'),
			'setting'     => array('text' => '基本设置', 'main' => '查看')
		) : array();
	}
	...
	private function check($permtype = '')
	{
		...
		$user = pdo_fetch('select u.status as userstatus,r.status as rolestatus,u.perms2 as userperms,r.perms2 as roleperms,u.roleid from ' . tablename('ewei_shop_perm_user') . ' u ' . ' left join ' . tablename('ewei_shop_perm_role') . ' r on u.roleid = r.id ' . ' where u.uid=:uid and u.uniacid = :uniacid limit 1 ', array(':uid' => $uid, ':uniacid' => intval($_W['uniacid'])));
	...
	protected function perm_sns()
	{
		return $this->isopen('sns') && $this->is_perm_plugin('sns') ? array(
			...
			'posts'    => array('text' => '话题管理', 'main' => '查看', 'add' => '发表话题-log', 'edit' => '编辑话题-log', 'delete' => '删除-log', 'delete1' => '彻底删除-log', 'check' => '审核-log', 'best' => '精华-log', 'top' => '置顶-log'),
			'replys'   => array('text' => '评论管理', 'main' => '查看', 'delete' => '删除-log', 'delete1' => '彻底删除-log', 'check' => '审核-log'),
			'complain' => array('text' => '投诉管理', 'main' => '查看', 'category' => '投诉类别', 'delete' => '删除-log', 'delete1' => '彻底删除-log', 'check' => '审核-log'),
			'cover'    => array('text' => '入口设置', 'main' => '查看', 'edit' => '修改-log'),
			'notice'   => array('text' => '通知设置', 'main' => '查看', 'edit' => '修改-log'),
			'set'      => array('text' => '基础设置', 'main' => '查看', 'edit' => '修改-log')
		) : array();
