...
class Comment_EweiShopV2Page extends PluginWebPage
{
	public function main()
	{
		...
		$psize = 20;
		$condition = ' and c.uniacid=:uniacid and c.deleted=0 and g.merchid=0 and g.type=9 ';
	...
	protected function virtual()
	{
		...
		if ($_W['ispost']) {
			...
			show_json(1, array('url' => webUrl('cycelbuy/comment')));
		}
		...
		include $this->template('cycelbuy/comment/virtual');
	}
