			...
			if (!empty($id)) {
				...
				if ($data['goodstype'] == 3 || 0 < $data['packetmoney'] || 0 < $data['packettotal']) {
					if ($data['packettype'] == 0) {
						...
						if (intval($_GPC['goodstype']) == 3 && floatval($_GPC['maxpacketmoney']) < floatval($_GPC['minpacketmoney'])) {
