...
if (!class_exists("CommissionModel")) {
    class CommissionModel extends PluginModel
    {
        ...
        public function calculate($orderid = 0, $update = true, $order_agentid = NULL)
        {
            ...
            $order = pdo_fetch("select agentid,price,goodsprice,deductcredit2,discountprice,isdiscountprice,dispatchprice,changeprice,ispackage,packageid,couponprice,buyagainprice from " . tablename("ewei_shop_order") . " where id=:id limit 1", array(":id" => $orderid));
        ...
        public function sendMessage($openid = "", $data = array(), $message_type = "")
        {
            ...
            if ($message_type == TM_COMMISSION_AGENT_NEW && empty($usernotice["commission_agent_new"])) {
                ...
                if ($tm["is_advanced"]) {
                    ...
                    $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您新增了一个" . $set["texts"]["down"] . $data["nickname"], "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => "新增下级通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您新增了一个下级" . $data["nickname"], "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                    $toopenid = $openid;
                    ...
                    $msg = array("keyword1" => isset($tm["commission_agent_newtitle"]) && trim($tm["commission_agent_newtitle"]) == "新增下级通知" ? "" : array("value" => "新增下级通知", "color" => "#73a68d"), "keyword2" => array("value" => !empty($tm["commission_agent_newtitle"]) ? $tm["commission_agent_newtitle"] : "恭喜您新增下级成员", "color" => "#73a68d"), "keyword3" => array("value" => $message, "color" => "#73a68d"));
                ...
                if ($message_type == TM_COMMISSION_ORDER_PAY && empty($usernotice["commission_order_pay"])) {
                    if ($tm["is_advanced"]) {
                        ...
                        $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["down"] . $data["nickname"] . "已付款", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => $set["texts"]["down"] . "付款通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的下级" . $data["nickname"] . "已经成功付款", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                        $toopenid = $openid;
                        $datas[] = array("name" => "昵称", "value" => $data["nickname"]);
                        $datas[] = array("name" => "下级昵称", "value" => $data["nickname"]);
                        ...
                        $msg = array("keyword1" => isset($tm["commission_order_paytitle"]) && trim($tm["commission_order_paytitle"]) == $set["texts"]["down"] . "付款通知" ? "" : array("value" => $set["texts"]["down"] . "付款通知", "color" => "#73a68d"), "keyword2" => array("value" => !empty($tm["commission_order_paytitle"]) ? $tm["commission_order_paytitle"] : "您有下级付款了"), "keyword3" => array("value" => $message));
                    ...
                    if ($message_type == TM_COMMISSION_ORDER_FINISH && empty($usernotice["commission_order_finish"])) {
                        if ($tm["is_advanced"]) {
                            ...
                            $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["down"] . $data["nickname"] . "已确认收货", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => $set["texts"]["down"] . "收货通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的下级" . $data["nickname"] . "已经确认收货", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                            $toopenid = $openid;
                        ...
                        if ($message_type == TM_COMMISSION_APPLY && empty($usernotice["commission_apply"])) {
                            if ($tm["is_advanced"]) {
                                ...
                                $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["commission"] . "提现申请已提交", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => "提现申请提交通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的佣金提现申请已提交", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                                $toopenid = $openid;
                                $datas[] = array("name" => "昵称", "value" => $member["nickname"]);
                            ...
                            if ($message_type == TM_COMMISSION_CHECK && empty($usernotice["commission_check"])) {
                                if ($tm["is_advanced"]) {
                                    ...
                                    $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["commission"] . "提现申请已审核通过", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => "提现申请审核通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的佣金提现申请审核完成", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                                    $toopenid = $openid;
                                    $datas[] = array("name" => "昵称", "value" => $member["nickname"]);
                                    $datas[] = array("name" => "时间", "value" => $time);
                                    $datas[] = array("name" => "金额", "value" => $data["commission"]);
                                ...
                                if ($message_type == TM_COMMISSION_PAY && empty($usernotice["commission_pay"])) {
                                    if ($tm["is_advanced"]) {
                                        ...
                                        $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的" . $set["texts"]["commission1"] . "打款成功", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => $set["texts"]["commission1"] . "打款通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的佣金提现已打款成功", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                                        $toopenid = $openid;
                                        $datas[] = array("name" => "昵称", "value" => $member["nickname"]);
                                        $datas[] = array("name" => "时间", "value" => $time);
                                        $datas[] = array("name" => "金额", "value" => $data["commission"]);
                                    ...
                                    if ($message_type == TM_COMMISSION_UPGRADE && empty($usernotice["commission_upgrade"])) {
                                        if ($tm["is_advanced"]) {
                                            ...
                                            $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，恭喜您成为" . $data["newlevel"]["levelname"] . $set["texts"]["agent"], "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => $set["texts"]["agent"] . "等级升级通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的" . $set["texts"]["agent"] . "等级从" . $data["oldlevel"]["levelname"] . "升级为" . $data["oldlevel"]["levelname"] . "特此通知!", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                                            $toopenid = $openid;
                                            $datas[] = array("name" => "昵称", "value" => $member["nickname"]);
                                            $datas[] = array("name" => "时间", "value" => $time);
                                        ...
                                        if ($message_type == TM_COMMISSION_BECOME && empty($usernotice["commission_become"])) {
                                            ...
                                            if ($tm["is_advanced"]) {
                                                ...
                                                $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，恭喜您" . $set["texts"]["become"], "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => "成为" . $set["texts"]["agent"] . "通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "成为" . $set["texts"]["agent"] . "通知", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                                                $toopenid = $openid;
                                                $datas[] = array("name" => "昵称", "value" => $data["nickname"]);
                                            ...
                                            if ($message_type == TM_COMMISSION_APPLYMONEY && empty($usernotice["commission_applymoney"])) {
                                                if ($tm["is_advanced"]) {
                                                    ...
                                                    $message = array("first" => array("value" => "亲爱的管理员您有一条新的" . $set["texts"]["commission"] . "提现申请", "color" => "#ff0000"), "keyword1" => array("title" => "业务类型", "value" => "佣金提现", "color" => "#000000"), "keyword2" => array("title" => "处理进度", "value" => "商户名称:" . $member["nickname"], "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "佣金提现:" . $data["commission"] . "元", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                                                    $toopenid = $tm["openid"];
                                                    $datas[] = array("name" => "昵称", "value" => $member["nickname"]);
                                                    $datas[] = array("name" => "时间", "value" => $time);
                                                    $datas[] = array("name" => "金额", "value" => $data["commission"]);
