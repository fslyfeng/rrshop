...
';
						$message = array(
							'first'    => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['down'] . $data['nickname'] . '已付款', 'color' => '#ff0000'),
							'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
							'keyword2' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经成功付款', 'color' => '#000000'),
							'keyword3' => array('title' => '处理结果', 'value' => $set['texts']['down'] . '付款通知', 'color' => '#000000'),
...
感谢您的支持', 'color' => '#000000')
						...
						$msg = array(
							'keyword1' => isset($tm['commission_order_paytitle']) && trim($tm['commission_order_paytitle']) == $set['texts']['down'] . '付款通知' ? '' : array('value' => $set['texts']['down'] . '付款通知', 'color' => '#73a68d'),
							'keyword2' => array('value' => !empty($tm['commission_order_paytitle']) ? $tm['commission_order_paytitle'] : '您有下级付款了'),
							'keyword3' => array('value' => $message),
							'keyword4' => array('value' => date('Y-m-d H:i:s', time()))
						);
...
';
							$message = array(
								'first'    => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['down'] . $data['nickname'] . '已确认收货', 'color' => '#ff0000'),
								'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
								'keyword2' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经确认收货', 'color' => '#000000'),
								'keyword3' => array('title' => '处理结果', 'value' => $set['texts']['down'] . '收货通知', 'color' => '#000000'),
								'keyword4' => array('title' => '操作时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'),
								'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
							);
							...
							$msg = array(
								'keyword1' => isset($tm['commission_order_finishtitle']) && trim($tm['commission_order_finishtitle']) == $set['texts']['down'] . '确认收货通知' ? '' : array('value' => $set['texts']['down'] . '确认收货通知', 'color' => '#73a68d'),
								'keyword2' => array('value' => !empty($tm['commission_order_finishtitle']) ? $tm['commission_order_finishtitle'] : '您有下级确认收货了', 'color' => '#73a68d'),
								'keyword3' => array('value' => $message, 'color' => '#73a68d')
							);
...
';
								$message = array(
									'first'    => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['commission'] . '提现申请已提交', 'color' => '#ff0000'),
									'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
...
感谢您的支持', 'color' => '#000000')
								...
								$msg = array(
									'keyword1' => isset($tm['commission_applytitle']) && trim($tm['commission_applytitle']) == '提现申请提交通知' ? '' : array('value' => '提现申请提交通知', 'color' => '#73a68d'),
									'keyword2' => array('value' => !empty($tm['commission_applytitle']) ? $tm['commission_applytitle'] : '您的提现申请已经提交', 'color' => '#73a68d'),
									'keyword3' => array('value' => $message, 'color' => '#73a68d')
								);
...
';
									$message = array(
										'first'    => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['commission'] . '提现申请已审核通过', 'color' => '#ff0000'),
										'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
...
感谢您的支持', 'color' => '#000000')
									...
									$msg = array(
										'keyword1' => isset($tm['commission_checktitle']) && trim($tm['commission_checktitle']) == '提现申请审核完成通知' ? '' : array('value' => '提现申请审核完成通知', 'color' => '#73a68d'),
										'keyword2' => array('value' => !empty($tm['commission_checktitle']) ? $tm['commission_checktitle'] : '您的提现申请已完成审核', 'color' => '#73a68d'),
										'keyword3' => array('value' => $message, 'color' => '#73a68d')
									);
...
';
										$message = array(
											'first'    => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['commission1'] . '打款成功', 'color' => '#ff0000'),
											'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
											'keyword2' => array('title' => '业务内容', 'value' => '您的佣金提现已打款成功', 'color' => '#000000'),
											'keyword3' => array('title' => '处理结果', 'value' => $set['texts']['commission1'] . '打款通知', 'color' => '#000000'),
											'keyword4' => array('title' => '操作时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'),
											'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
										);
										...
										$msg = array(
											'keyword1' => isset($tm['commission_paytitle']) && trim($tm['commission_paytitle']) == '佣金打款通知' ? '' : array('value' => '佣金打款通知', 'color' => '#73a68d'),
											'keyword2' => array('value' => !empty($tm['commission_paytitle']) ? $tm['commission_paytitle'] : '您的佣金已打款', 'color' => '#73a68d'),
											'keyword3' => array('value' => $message, 'color' => '#73a68d')
										);
...
';
											$message = array(
												'first'    => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成为' . $data['newlevel']['levelname'] . $set['texts']['agent'], 'color' => '#ff0000'),
												'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
												'keyword2' => array('title' => '业务内容', 'value' => '您的' . $set['texts']['agent'] . '等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['oldlevel']['levelname'] . '特此通知!', 'color' => '#000000'),
												'keyword3' => array('title' => '处理结果', 'value' => $set['texts']['agent'] . '等级升级通知', 'color' => '#000000'),
												'keyword4' => array('title' => '操作时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'),
												'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
											);
											...
											$msg = array(
												'keyword1' => array('value' => $set['texts']['agent'] . '等级升级通知', 'color' => '#73a68d'),
												'keyword2' => array('value' => !empty($tm['commission_upgradetitle']) ? $tm['commission_upgradetitle'] : '恭喜您升级了', 'color' => '#73a68d'),
												'keyword3' => array('value' => $message, 'color' => '#73a68d')
											);
...
';
												$message = array(
													...
													'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
													'keyword2' => array('title' => '业务内容', 'value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#000000'),
...
感谢您的支持', 'color' => '#000000')
												...
												$msg = array(
													'keyword1' => array('value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#73a68d'),
													'keyword2' => array('value' => !empty($tm['commission_becometitle']) ? $tm['commission_becometitle'] : '恭喜您成为' . $set['texts']['agent'], 'color' => '#73a68d'),
													'keyword3' => array('value' => $message, 'color' => '#73a68d')
												);
...
';
													$message = array(
														'first'    => array('value' => '亲爱的管理员您有一条新的' . $set['texts']['commission'] . '提现申请', 'color' => '#ff0000'),
														'keyword1' => array('title' => '业务类型', 'value' => '佣金提现', 'color' => '#000000'),
														'keyword2' => array('title' => '业务内容', 'value' => '佣金提现:' . $data['commission'] . '元', 'color' => '#000000'),
														'keyword3' => array('title' => '处理结果', 'value' => '商户名称:' . $member['nickname'], 'color' => '#000000'),
														'keyword4' => array('title' => '操作时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#000000'),
														'remark'   => array('value' => '
感谢您的支持', 'color' => '#000000')
													);
													...
													$msg = array(
														'keyword1' => array('value' => $set['texts']['agent'] . '提现通知', 'color' => '#73a68d'),
														'keyword2' => array('value' => !empty($tm['commission_applymoneytitle']) ? $tm['commission_applymoneytitle'] : '您有' . $set['texts']['agent'] . '申请提现了', 'color' => '#73a68d'),
														'keyword3' => array('value' => $message, 'color' => '#000000')
													);
