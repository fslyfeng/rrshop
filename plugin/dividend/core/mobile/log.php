...
class Log_EweiShopV2Page extends DividendMobileLoginPage
{
	...
	public function get_list()
	{
		...
		unset($row);
		show_json(1, array('total' => $total, 'list' => $list, 'pagesize' => $psize, 'dividendcount' => number_format($dividendcount, 2)));
	}
	...
	public function orders()
	{
		...
		unset($row);
		show_json(1, array('list' => $list, 'pagesize' => $psize, 'total' => $total, 'totaldividend' => $totaldividend));
	}
}
