    ...
    class AppModel extends PluginModel
    {
                            ...
                            if ($item["id"] == "richtext") {
                                ...
                                if ($item["id"] == "menu" && !empty($item["style"]["showtype"])) {
                                    ...
                                    if ($item["id"] == "picturew" && !empty($item["params"]["showtype"])) {
                                        ...
                                        if ($item["id"] == "notice" && empty($item["params"]["noticedata"])) {
                                                ...
                                                if ($item["id"] == "audio") {
                                                    ...
                                                    if ($item["id"] == "icongroup") {
                                                        ...
                                                        if ($item["id"] == "goods") {
                                                            if (!empty($item["data"])) {
                                                                if (!empty($item["params"]["goodsscroll"])) {
                                                                    ...
                                                                    if ($item["style"]["liststyle"] == "block") {
                                                                        ...
                                                                        if ($item["style"]["liststyle"] == "block three") {
                                                                            $swiperpage = 3;
                                                                        }
                                                                    }
                                                                    $data_temp = array();
                                                                ...
                                                                if ($item["params"]["showicon"] == 1) {
                                                                    if ($item["style"]["goodsicon"] == "recommand") {
                                                                        ...
                                                                        if ($item["style"]["goodsicon"] == "hotsale") {
                                                                            $item["style"]["goodsicon"] = "热销";
                                                                        } else {
                                                                            if ($item["style"]["goodsicon"] == "isnew") {
                                                                                $item["style"]["goodsicon"] = "新上";
                                                                            } else {
                                                                                if ($item["style"]["goodsicon"] == "sendfree") {
                                                                                    $item["style"]["goodsicon"] = "包邮";
                                                                                } else {
                                                                                    if ($item["style"]["goodsicon"] == "istime") {
                                                                                        $item["style"]["goodsicon"] = "限时购";
                                                                                    } else {
                                                                                        if ($item["style"]["goodsicon"] == "bigsale") {
                                                                ...
                                                                if ($item["params"]["saleout"] == 0 && !empty($_W["shopset"]["shop"]["saleout"])) {
                                                                    ...
                                                                    if ($item["params"]["saleout"] == 1 && !empty($item["style"]["saleoutstyle"])) {
                                                            ...
                                                            if ($item["id"] == "topmenu" && !empty($item["style"]["showtype"])) {
                                                                if (!empty($item["data"])) {
                                                                    $swiperpage = empty($item["style"]["pagenum"]) ? 8 : $item["style"]["pagenum"];
                                                                    $data_temp = array();
                                                                    $k = 0;
            ...
            if ($item["id"] == "goods") {
                if (empty($item["params"]["goodsdata"]) && !empty($item["data"]) && is_array($item["data"])) {
                    ...
                    if (!empty($goodsids) && is_array($goodsids)) {
                        ...
                        array_walk($goods, function (&$goodsItem) {
                            $in_time = true;
                            if ($goodsItem["presellstart"] && time() < $goodsItem["preselltimestart"]) {
                                $in_time = false;
                            }
                            if ($goodsItem["presellend"] && $goodsItem["preselltimeend"] < time()) {
                                $in_time = false;
                            }
                            if ($goodsItem["ispresell"] && $goodsItem["presellprice"] < $goodsItem["minprice"] && $in_time) {
                                $goodsItem["minprice"] = $goodsItem["presellprice"];
                            }
                        });
                    }
                } else {
                    if ($item["params"]["goodsdata"] == 1 && !empty($item["params"]["cateid"]) && $mobile) {
                        $orderby = " displayorder desc, createtime desc";
                        if ($item["params"]["goodssort"] == 1) {
                            $orderby = " sales+salesreal desc, displayorder desc";
                        } else {
                            if ($item["params"]["goodssort"] == 2) {
                                $orderby = " minprice desc, displayorder desc";
                            } else {
                                if ($item["params"]["goodssort"] == 3) {
                        ...
                        if ($item["params"]["goodsdata"] == 2 && !empty($item["params"]["groupid"]) && $mobile) {
                            ...
                            if (2 < $item["params"]["goodsdata"] && $mobile) {
                                ...
                                if ($item["params"]["goodsdata"] == 3) {
                                    ...
                                    if ($item["params"]["goodsdata"] == 4) {
                                        $args["ishot"] = 1;
                                    } else {
                                        if ($item["params"]["goodsdata"] == 5) {
                                            $args["isrecommand"] = 1;
                                        } else {
                                            if ($item["params"]["goodsdata"] == 6) {
                                                $args["isdiscount"] = 1;
                                            } else {
                                                if ($item["params"]["goodsdata"] == 7) {
                                                    $args["issendfree"] = 1;
                                                } else {
                ...
                if (!empty($goods) && is_array($goods)) {
                    ...
                    if (empty($item["params"]["goodsdata"])) {
                        ...
                        foreach ($goods as $index => $good) {
                            $childid = "C" . rand(1000000000, 9999999999.0);
        ...
        public function goodsCG($item)
        {
            ...
            if ($item["id"] == "goods") {
                if ($item["params"]["goodsdata"] == 1 && !empty($item["params"]["cateid"])) {
                    ...
                    if ($item["params"]["goodsdata"] == 2 && !empty($item["params"]["groupid"])) {
        ...
        public function getUrl($url)
        {
            ...
            if (strexists($url, "./index.php?") && strexists($url, "ewei_shopv2") && strexists($url, "mobile")) {
                ...
                $newVars["r"] = !empty($newVars["r"]) ? $newVars["r"] : "index";
                $route = $newVars["r"];
                unset($newVars["i"]);
                unset($newVars["c"]);
                unset($newVars["m"]);
        ...
        public function sendMessage($openid = "", $data = array(), $message_type = "")
        {
            ...
            if ($message_type == TM_CYCELBUY_SELLER_DATE) {
                ...
                $message = array("first" => array("value" => $data["nickname"] . "修改了收货时间", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "修改收货时间通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => $data["nickname"] . "修改了收货时间", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                ...
                if ($message_type == TM_CYCELBUY_SELLER_ADDRESS) {
                    ...
                    $message = array("first" => array("value" => $data["nickname"] . "修改了收货地址！", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "修改收货地址通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => $data["nickname"] . "修改了收货地址", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                    $datas[] = array("name" => "昵称", "value" => $data["nickname"]);
                    ...
                    if ($message_type == TM_CYCELBUY_BUYER_DATE) {
                        if ($tm["cycelbuy_buyer_date_close_advanced"]) {
                            return false;
                        }
                        $tag = "cycelbuy_buyer_date";
                        $text = "您已修改了收货时间！\n" . date("Y-m-d H:i") . "\n";
                        $message = array("first" => array("value" => "亲爱的" . $data["nickname"] . "，您修改了收货时间", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "修改收货时间通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的收货时间已修改", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                        $toopenid = $openid;
                        $datas[] = array("name" => "昵称", "value" => $data["nickname"]);
                        ...
                        if ($message_type == TM_CYCELBUY_BUYER_ADDRESS) {
                            if ($tm["cycelbuy_buyer_address_close_advanced"]) {
                                return false;
                            }
                            $tag = "cycelbuy_buyer_address";
                            $text = "您的收货地址已修改！\n" . date("Y-m-d H:i") . "\n";
                            $message = array("first" => array("value" => "亲爱的" . $member["nickname"] . "，您的收货地址修改完成", "color" => "#ff0000"), "keyword2" => array("title" => "处理进度", "value" => "修改收货地址通知", "color" => "#000000"), "keyword3" => array("title" => "处理内容", "value" => "您的收货地址修改已完成", "color" => "#000000"), "keyword1" => array("title" => "业务类型", "value" => "会员通知", "color" => "#000000"), "remark" => array("value" => "\n感谢您的支持", "color" => "#000000"));
                            $toopenid = $openid;
