...
class Refund_EweiShopV2Page extends PluginWebPage
{
	...
	public function main()
	{
		...
		try {
			...
			$list = pdo_fetchall('SELECT o.addressid,o.goodid,o.pay_type,o.price,o.creditmoney,o.is_team,o.refundid,ore.*,g.title,g.thumb,g.category,g.groupsprice,g.singleprice,c.name,g.thumb,g.thumb_url
	...
	public function detail()
	{
		...
		try {
			...
			$refund = pdo_fetch('SELECT ore.*,o.price,o.credit,o.freight,o.paytime,o.pay_type,o.orderno,o.goodid,g.title,g.thumb,g.thumb_url,g.category,g.groupsprice
                FROM ' . tablename('ewei_shop_groups_order_refund') . ' as ore
